      ...
      <div className={`flex flex-col items-center justify-start pt-8 flex-1 w-full max-w-sm mx-auto transition-all duration-700 ${
        ...
        <div className="mt-6 w-full">
          ...
          <p className="text-gray-300 text-center leading-relaxed dm-sans text-sm">
            En Cielo y Tierra combinamos lo mejor de ambos mundos: sabores celestiales que elevan tu paladar y 
            tentaciones terrenales que despiertan tus sentidos. Cada plato es una experiencia única que une 
        ...
        <div className="mt-5 flex justify-center space-x-6">
          ...
          <a 
            ...
            className="w-12 h-12 bg-gray-800 hover:bg-primary-red rounded-full flex items-center justify-center transition-colors duration-300 shadow-lg hover:shadow-primary-red/30"
            aria-label="TikTok"
          >
